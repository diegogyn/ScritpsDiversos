...
$MOUNT -t nfs 192.168.200.7:/mnt/backup/areca	/mnt/areca >> $LOG 2>&1
sleep 10
echo "============================================================" >> $LOG 2>&1
echo >> $LOG 2>&1
...
echo "============================================================" >> $LOG 2>&1
echo 								>> $LOG 2>&1
echo "============ INICIO ARECA `$DATE`: SIGA DIARIO ==========" >> $LOG 2>&1
/opt/areca/scripts/arecadiario.sh				>> $LOG 2>&1
echo "============ FIM ARECA `$DATE`: SIGA DIARIO =============" >> $LOG 2>&1
echo 								>> $LOG 2>&1
